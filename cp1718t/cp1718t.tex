...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Block}\mathrel{=}\Conid{MagicNo}\times(\Conid{Time}\times\Conid{Transactions})}
...
\xymatrix@C=2.5cm{
    \ensuremath{\Conid{Block}\times\Conid{Transactions}}
           \ar[r]_-{\ensuremath{\Varid{g1}\times\Varid{id}\mathrel{=}\p2\comp \p2\times\Varid{id}}}    
&
    \ensuremath{\Conid{Transactions}\times\Conid{Transactions}}
            \ar[r]_-{\ensuremath{\mathsf{conc}}}     
&
    \ensuremath{\Conid{Transactions}}    
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Blockchain}}
           \ar[d]_-{\ensuremath{\Varid{ledger}\mathrel{=}\cata{\Varid{g}}}}
           \ar[r]_-{\ensuremath{\Varid{outBlockchain}}}            
&
    \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times\Conid{Blockchain}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{ledger}}}
\\
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Block}\mathrel{=}\Conid{MagicNo}\times(\Conid{Time}\times\Conid{Transactions})}
            \ar[r]_-{\ensuremath{\p2\comp \p2}}    
&
    \ensuremath{\Conid{Transactions}\mathrel{=}((\Conid{Entity},(\Conid{Value},\Conid{Entity})))\mathbin{*}}
            \ar[d]_-{\ensuremath{\map \;(\Varid{swap}\comp \p2)}}  
\\
&
    \ensuremath{(\Conid{Entity},\Conid{Value})\mathbin{*}\mathrel{=}\Conid{Ledger}}
}
\end{eqnarray*}

\xymatrix@C=4.5cm{
    \ensuremath{\Conid{Block}\times\Conid{Ledger}}
           \ar[r]_-{\ensuremath{\Varid{g1}\times\Varid{id}\mathrel{=}(\map \;(\Varid{swap}\comp \p2)\comp \p2\comp \p2)\times\Varid{id}}}    
&
    \ensuremath{\Conid{Ledger}\times\Conid{Ledger}\mathrel{=}(\Conid{Entity},\Conid{Value})\mathbin{*}\times(\Conid{Entity},\Conid{Value})\mathbin{*}}
            \ar[d]_-{\ensuremath{\mathsf{conc}}}     
\\
&
    \ensuremath{(\Conid{Entity},\Conid{Value})\mathbin{*}\mathrel{=}\Conid{Ledger}}    
}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{cataBlockchain}\;\alt{\map \;(\Varid{swap}\comp \p2)\comp \p2\comp \p2}{\mathsf{conc}\comp ((\map \;(\Varid{swap}\comp \p2)\comp \p2\comp \p2)\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Blockchain}}
           \ar[d]_-{\ensuremath{\Varid{magicNrList}\mathrel{=}\cata{\Varid{g}}}}
           \ar[r]_-{\ensuremath{\Varid{outBlockchain}}}           
&
    \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times\Conid{Blockchain}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{magicNrList}}}
\\
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Block}\times(\Conid{MagicNo})\mathbin{*}}
            \ar[r]_-{\ensuremath{\Varid{singl}\comp \p1\times\Varid{id}}}    
&
    \ensuremath{(\Conid{MagicNo})\mathbin{*}\times(\Conid{MagicNo})\mathbin{*}}
            \ar[r]_-{\ensuremath{\mathsf{conc}}}
&
    \ensuremath{(\Conid{MagicNo})\mathbin{*}}    
}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{semRepetidos}\comp (\Varid{cataBlockchain}\;\alt{\Varid{singl}\comp \p1}{\mathsf{conc}\comp (\Varid{singl}\comp \p1\times\Varid{id})}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{semRepetidos}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{semRepetidos}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{semRepetidos}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\mathbf{if}\;(\Varid{elem}\;\Varid{h}\;\Varid{t}\equiv \Conid{True}){}\<[E]%
\\
\>[11]{}\hsindent{21}{}\<[32]%
\>[32]{}\mathbf{then}\;\Conid{False}{}\<[E]%
\\
\>[11]{}\hsindent{21}{}\<[32]%
\>[32]{}\mathbf{else}\;\Varid{semRepetidos}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inQTree}\mathrel{=}\alt{\Varid{cellAux}\;\Conid{Cell}}{\Varid{blockAux}\;\Conid{Block}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{cellAux}\;\Varid{f}\;(\Varid{x},(\Varid{y},\Varid{z}))\mathrel{=}\Varid{f}\;\Varid{x}\;\Varid{y}\;\Varid{z}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{blockAux}\;\Varid{g}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{recQTree}\;\Varid{g}\mathrel{=}\Varid{id}+(\Varid{g}\times(\Varid{g}\times(\Varid{g}\times\Varid{g}))){}\<[E]%
\\
...
&
    \ensuremath{\Conid{A}\mathbin{+}(\Conid{QTree}\;\Conid{A})}^4
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{rotateQTree}}^4}
\\
     \ensuremath{\Conid{QTree}\;\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}(\Conid{QTree}\;\Conid{A})}^4
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\Varid{inQTree}\comp (\Varid{g1}\mathbin{+}\Varid{g2})}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{A}\mathrel{=}\Conid{Cell}\;\N_0\times\N_0\times\N_0}
            \ar[r]_-{\ensuremath{\Varid{id}\times\Varid{swap}}}    
&
    \ensuremath{\Conid{Cell}\;\N_0\times\N_0\times\N_0\mathrel{=}\Conid{A}} 
}
\end{eqnarray*}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp (\Varid{id}\times\Varid{swap}+\Varid{g2})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g2}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{c},(\Varid{a},(\Varid{d},\Varid{b}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{A}\mathbin{+}(\Conid{QTree}\;\Conid{A})}^4
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{scaleQTree}}^4}
\\
     \ensuremath{\Conid{QTree}\;\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}(\Conid{QTree}\;\Conid{A})}^4
...
Para o caso do \textit{Block} correspondente às quatro \textit{QTree} do esquema acima -- e que contém o resultado recursivo da aplicação desta função às subárvores --, não é preciso fazer mais nada, pelo que o \textit{g2} corresponde apenas a um \ensuremath{\Varid{id}}.
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{k}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp (\Varid{g1}+\Varid{id})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g1}\;(\Varid{a},(\Varid{x},\Varid{y}))\mathrel{=}(\Varid{a},(\Varid{x}\mathbin{*}\Varid{k},\Varid{y}\mathbin{*}\Varid{k})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2.5cm{
    \ensuremath{\Conid{QTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{invertQTree}\mathrel{=}\cata{\Varid{g}}}}
           \ar[r]_-{\ensuremath{\Varid{outQTree}}}           
&
    \ensuremath{\Conid{A}\mathbin{+}(\Conid{QTree}\;\Conid{A})}^4
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{invertQTree}}^4}
\\
     \ensuremath{\Conid{QTree}\;\Conid{A}}
&
     \ensuremath{\Conid{A}\mathbin{+}(\Conid{QTree}\;\Conid{A})}^4
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invertQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp (\Varid{g1}+\Varid{id})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g1}\;(\Varid{p},(\Varid{x},\Varid{y}))\mathrel{=}(\Varid{invertColor}\;\Varid{p},(\Varid{x},\Varid{y})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outlineQTree}\;\Varid{p}\mathrel{=}\Varid{qt2bm}\comp \Varid{cataQTree}\;(\Varid{inQTree}\comp (\Varid{aux}+(\Varid{id}\times(\Varid{id}\times(\Varid{id}\times\Varid{id}))))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{aux}\;(\Varid{a},(\Varid{x},\Varid{y}))\mathrel{=}\mathbf{if}\;(\Varid{p}\;\Varid{a})\equiv \Conid{True}{}\<[E]%
\\
\>[5]{}\hsindent{22}{}\<[27]%
\>[27]{}\mathbf{then}\;(\Conid{True},(\Varid{x},\Varid{y})){}\<[E]%
\\
\>[5]{}\hsindent{22}{}\<[27]%
\>[27]{}\mathbf{else}\;(\Conid{False},(\Varid{x},\Varid{y})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Tal como queríamos inicialmente, a solução encontra-se sob a forma \ensuremath{\mathsf{for}\ \Varid{b}\ \Varid{i}\mathrel{=}\cata{\alt{\underline{\Varid{i}}}{\Varid{b}}}}, pelo que podemos retirar \textit{base} e \textit {loop} (\textit{i} e \textit{b}).

Assim sendo:
\begin{itemize}
\item \textit{base} corresponderá ao primeiro componente do \textit{either} do resultado: \ensuremath{\conj{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\underline{\mathrm{1}}}{\succ }}}
\item \textit{loop} corresponderá ao segundo componente do \textit{either} do resultado: \ensuremath{\conj{\Varid{mul}}{\succ \comp \p2}\times\conj{\Varid{mul}}{\succ \comp \p2}}
\end{itemize}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{base}\;\Varid{k}\mathrel{=}\Varid{pairToTuple}\;((\mathrm{1},\Varid{k}\mathbin{+}\mathrm{1}),(\mathrm{1},\mathrm{1})){}\<[E]%
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{pairToTuple}\comp (\conj{\Varid{mul}}{\succ \comp \p2}\times\conj{\Varid{mul}}{\succ \comp \p2})\comp \Varid{tupleToPair}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pairToTuple}\mathbin{::}((\Varid{t0},\Varid{t1}),(\Varid{t2},\Varid{t3}))\to (\Varid{t0},\Varid{t1},\Varid{t2},\Varid{t3}){}\<[E]%
\\
\>[B]{}\Varid{pairToTuple}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tupleToPair}\mathbin{::}(\Varid{t0},\Varid{t1},\Varid{t2},\Varid{t3})\to ((\Varid{t0},\Varid{t1}),(\Varid{t2},\Varid{t3})){}\<[E]%
\\
\>[B]{}\Varid{tupleToPair}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inFTree}\mathrel{=}\alt{\Conid{Unit}}{\Varid{compAux}\;\Conid{Comp}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{compAux}\;\Varid{g}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{recFTree}\;\Varid{g}\mathrel{=}\Varid{id}+(\Varid{id}\times(\Varid{g}\times\Varid{g})){}\<[E]%
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{genSquare}\mathbin{::}(\Conid{Int},\Conid{Int})\to (\Conid{Square})+(\Conid{Square},((\Conid{Int},\Conid{Int}),(\Conid{Int},\Conid{Int}))){}\<[E]%
\\
\>[B]{}\Varid{genSquare}\;(\Varid{o},\Varid{n})\mathrel{=}\mathbf{let}\;\Varid{calculateSide}\;\Varid{x}\mathrel{=}\Varid{fromIntegral}\;(\Varid{x})\mathbin{*}(\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2}){}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mathbf{in}\;\mathbf{if}\;\Varid{o}\equiv \Varid{n}{}\<[E]%
\\
\>[19]{}\hsindent{3}{}\<[22]%
\>[22]{}\mathbf{then}\;i_1\;(\Varid{calculateSide}\;\Varid{o}){}\<[E]%
\\
\>[19]{}\hsindent{3}{}\<[22]%
\>[22]{}\mathbf{else}\;i_2\;(\Varid{calculateSide}\;\Varid{n},((\Varid{o},\Varid{n}\mathbin{+}\mathrm{1}),(\Varid{o},\Varid{n}\mathbin{+}\mathrm{1}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{generatePTree}\;\Varid{o}\mathrel{=}\Varid{anaFTree}\;\Varid{genSquare}\;(\Varid{o},\mathrm{0}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{singletonbag}\;\Varid{m}\mathrel{=}\mathit B\;[\mskip1.5mu (\Varid{m},\mathrm{1})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\subsubsection*{2. muB (multiplicação de \textit{Bag})}

\paragraph{} A função \textbf{\textit{\ensuremath{\mu }}} referente à multiplicação do mónade \textit{Bag} é uma função correspondente ao seguinte esquema:

\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Bag}\;(\Conid{Bag}\;\Varid{a})}
           \ar[r]_-{\ensuremath{\mu }}           
&
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{replicateMarbles}\mathbin{::}[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{replicateMarbles}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{replicateMarbles}\;((\Varid{m},\mathrm{0})\mathbin{:}\Varid{t})\mathrel{=}\Varid{replicateMarbles}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\Varid{replicateMarbles}\;((\Varid{m},\Varid{k})\mathbin{:}\Varid{t})\mathrel{=}\Varid{m}\mathbin{:}\Varid{replicateMarbles}\;((\Varid{m},\Varid{k}\mathbin{-}\mathrm{1})\mathbin{:}\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dist}\mathrel{=}\Varid{replicateMarbles}\comp \Varid{unB}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Se na função original \ensuremath{\mu }, começarmos por aplicar esta nova função \textit{dist}, o esquema de \ensuremath{\mu } passa a corresponder ao seguinte:
...
&
    \ensuremath{[\mskip1.5mu \Conid{Bag}\;\Varid{a}\mskip1.5mu]}
        \ar[r]_-{\ensuremath{\Varid{f}\mathrel{=}\mathbin{?}}}
&           
    \ensuremath{\Conid{Bag}\;\Varid{a}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{[\mskip1.5mu \Conid{Bag}\;\Varid{a}\mskip1.5mu]}
        \ar[r]_-{\ensuremath{\Varid{concatBags}}}           
&
    \ensuremath{\Conid{Bag}\;\Varid{a}}
&           
}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{concatBags}\mathbin{::}[\mskip1.5mu \Conid{Bag}\;\Varid{a}\mskip1.5mu]\to \Conid{Bag}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{concatBags}\;[\mskip1.5mu \mathit B\;\Varid{a}\mskip1.5mu]\mathrel{=}\mathit B\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{concatBags}\;(\mathit B\;\Varid{a}\mathbin{:}\mathit B\;\Varid{b}\mathbin{:}\Varid{t})\mathrel{=}\Varid{concatBags}\;(\mathit B\;(\Varid{a}\plus \Varid{b})\mathbin{:}\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Chegámos, então, ao esquema final da função \ensuremath{\mu } que queríamos obter inicialmente:
...
Por fim, podemos apresentar a codificação final da função \ensuremath{\mu }, correspondente ao esquema anterior:

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mu \mathrel{=}\Varid{concatBags}\comp \Varid{dist}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
