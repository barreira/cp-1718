...
%
\just\equiv{ "Banana-split" (51), Def-functor-\ensuremath{\Conid{Nat}} }
%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment base k = aux ((1, k+1), (1,1))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     where aux ((a,b), (c,d)) = (a,b,c,d)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment loop = aux2 . aux (split (mul) (succ.p2) >< split (mul) (succ.p2))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     where aux f (a,b,c,d) = f ((a,b),(c, d))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment           aux2 ((a,b), (c,d)) = (a,b,c,d)}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{genSquare}\;(\Varid{o},\Varid{n})\mid \Varid{o}\equiv \Varid{n}{}\<[29]%
\>[29]{}\mathrel{=}i_1\;(\Varid{calculateSide}\;\Varid{o}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(\Varid{calculateSide}\;\Varid{n},((\Varid{o},\Varid{n}\mathbin{+}\mathrm{1}),(\Varid{o},\Varid{n}\mathbin{+}\mathrm{1}))){}\<[E]%
\\[\blanklineskip]%
