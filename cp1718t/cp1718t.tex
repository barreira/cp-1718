...
\\
\>[B]{}\Varid{invertColor}\;(\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a})\mathrel{=}\Conid{PixelRGBA8}\;(\Varid{r}\mathbin{-}\mathrm{255})\;(\Varid{g}\mathbin{-}\mathrm{255})\;(\Varid{b}\mathbin{-}\mathrm{255})\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compAux}\;\Varid{g}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  calcular o tamanho para um lado qualquer}{}\<[E]%
\\
\>[B]{}\Varid{calculateSide}\mathbin{::}\Conid{Int}\to \Conid{Square}{}\<[E]%
\\
\>[B]{}\Varid{calculateSide}\;\Varid{x}\mathrel{=}\Varid{fromIntegral}\;(\Varid{x})\mathbin{*}(\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin 
...
caso recursivo calcula o lado atual e incrementa o nivel em que estamos \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{genSquare}\mathbin{::}(\Conid{Int},\Conid{Int})\to \Conid{Square}+(\Conid{Square},((\Conid{Int},\Conid{Int}),(\Conid{Int},\Conid{Int}))){}\<[E]%
\\
\>[B]{}\Varid{genSquare}\;(\Varid{o},\Varid{n})\mathrel{=}\mathbf{if}\;\Varid{o}\equiv \Varid{n}{}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mathbf{then}\;i_1\;(\Varid{calculateSide}\;\Varid{o}){}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mathbf{else}\;i_2\;(\Varid{calculateSide}\;\Varid{n},((\Varid{o},\Varid{n}\mathbin{+}\mathrm{1}),(\Varid{o},\Varid{n}\mathbin{+}\mathrm{1}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  funcao principal -> anamorfismo sobre a estrutura, invocando a funcao aux com o nivel 0 inicialmente}{}\<[E]%
\\
